...
{{--    <link rel="stylesheet" href="https://demo.learncodeweb.com/web-development/drag-drop-images-with-bootstrap-4-and-reorder-using-php-jquery-and-ajax/dropzone/dropzone.css" type="text/css">--}}
    ...
    <form method="post" action="/edit-Newsad/side-menu/light/{{$ads->id}}">
        @csrf
            ...
            <div class="intro-y col-span-12 lg:col-span-12 bg_">
                <div class="intro-y box p-5">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" class="input w-full border mt-2" name="url"   placeholder="{{__('admin.url')}}" value="{{$ads->url}}">
                        @if($errors->has('title'))
                    ...
                    <div class="mt-3">
                        ...
                        <input type="number" min="1" step="1" class="input w-full border mt-2" name="frequency"
                            placeholder="Frequency" value="{{ old('frequency', $ads->frequency ?? 1) }}">
                    ...
                    <!--            <input type="text" class="input w-full border mt-2 form-control datepicker"-->
                    <!--                   name="start_date" placeholder="{{__('admin.schedule_date_placeholder')}}"  value="{{$ads->start_date}}">-->
                    ...
                    <!--            <input type="text" class="input w-full border mt-2 form-control datepicker"-->
                    <!--                   name="end_date" placeholder="{{__('admin.schedule_date_placeholder')}}"  value="{{$ads->end_date}}">-->
                    ...
                    <!--</div>-->
                    <!-- Frequency field added above (kept simple number input). -->
                </div>
            </div>
        </div>
        <div></div>
                    ...
                    <div class="mt-3">
                        <div class="col-span-12 sm:col-span-4">
                            ...
                            <div class="col-span-12 sm:col-span-12">
                                ...
                                <input class="imageuploadBtn hide" id="images" type="file" name="images" onchange="uploadMultipleAdsImages(this,'image_image_add','add',0);" accept="image/*"/>
                            </div>
                                        ...
                                        <div class="col-span-12 xl:col-span-3">
                                            <div class="border border-gray-200 dark:border-dark-5 rounded-md p-5">
                                                <div class="w-40 h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                                    <img class="rounded-md" alt="" src="{{url('storage/newsads/'.$ads->image)}}">
                                                </div>
                                                <div class="w-40 mx-auto cursor-pointer relative mt-5">
                                                    <button type="button" class="button w-full bg-theme-1 text-white" onclick="deleteAdImage('{{$ads->id}}')">Delete Image</button>
                                                </div>
                                            </div> 
                                        </div>
