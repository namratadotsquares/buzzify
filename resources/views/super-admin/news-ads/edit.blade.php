...
@section('subcontent')
    ...
    <form method="post" action="/edit-Newsad/side-menu/light/{{$ads->id}}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="intro-y col-span-12 lg:col-span-12 bg_">
                <div class="intro-y box p-5">
                    <div class="mt-3">
                        ...
                        <input type="text" class="input w-full border mt-2" name="url"  placeholder="Url" value="{{$ads->url}}">
                        @if($errors->has('url'))
                ...
                <div class="intro-y box p-5">
                    <div class="mt-3">
                        <div class="col-span-12 sm:col-span-4">
                            <label>({{__('admin.images')}}) <span class="required">*</span> <mark>Upload only one image at a time</mark> </label>
