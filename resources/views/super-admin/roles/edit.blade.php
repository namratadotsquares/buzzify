                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($value->permission as $row)
                                            <td>
                                                <label>
                                                    <input type="checkbox" class="name form-check-input cardcheckbox" <?php if($row->display_name=='List'){ ?> id="list_{{$value->group_name}}" <?php }else{ ?> id="other_{{$value->group_name}}" onClick="selectPermission(this.id);" <?php } ?> name="permission[]" value="{{$row->id}}" {{in_array($row->id, $rolePermissions) || $row->is_default ? 'checked' : ''}}> {{ $row->display_name }}
                                                </label>
                                            </td>
                                        @endforeach
                                    </tr>
