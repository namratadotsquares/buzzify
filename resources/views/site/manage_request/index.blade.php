                    ...
                    <div class="row">
                        <div class="col-md-12 main_title_col">
                            <div class="jl_cat_mid_title">
                                <h3 class="categories-title title">{{ __('frontend.manage_request') }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-8 grid-sidebar">
                        ...
                        <table class="table table-fluid" id="myTable">
                            ...
                            <tbody>
                                @if(count($managereq))
                                <?php $i=1;  ?>   
                                    @foreach($managereq as $m)
                                    @if(isset($m->product))
                                        <tr style="text-align:left;">
                                            <td>{{$i}} </td>                                    
                                            <?php
                                                if(file_exists(public_path()."/upload/e-paper/original/".$m->product->img) && $m->product->img!='') {
                                                    $url = url('upload/e-paper/original').'/'.$m->product->img;
                                                    //echo $url; die;
                                                }else{
                                            ...
                                            <td>
                                                @if($m->status==0)
                                                    <span class="meta-category-small">
                                                        <a class="btn btn-custom" href="" style="text-decoration:none; background-color: #ba4df5; color: white; width:80px;height:25px;padding-top:8px;">Pending</a>
                                                    </span>
                                                @elseif($m->status==1)
                                                    <span class="meta-category-small"> 
                                                        <a class="btn btn-custom" href="" style="text-decoration:none; background-color: green; color: white; width:80px;height:25px;padding-top:8px;">Accepted</a>
                                                    </span>
                                                @else
                                                    <span class="meta-category-small">
                                                        <a class="btn btn-custom" href="" style="text-decoration:none; background-color: red; color: white; width:80px;height:25px;padding-top:8px;">Rejected</a>
                                                    </span>
                                                @endif
                                            </td>      
                                        </tr> 
