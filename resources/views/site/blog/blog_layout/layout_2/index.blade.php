    ...
    <div class="options_layout_container full_layout_enable_front no_transform">
        ...
        <div class="jl_single_style4">
            <div class="single_content_header single_captions_overlay_bottom_image_full_width">
                <div class="image-post-thumb" style="background-image: url('{{url('upload/blog/banner/original/')}}/{{$blog_detail->blog_image}}');"></div>
                            ...
                            <div class="col-md-12">
                                <div class="single_post_entry_content">
                                    ...
                                    <span class="single-post-meta-wrapper">
                                        ...
                                        @if(Auth::user()) @if($blog_detail->isBookmarked==0)
            ...
            <div class="container no_transform">
                <div class="row main_content no_transform">
                    <div class="col-md-8 loop-large-post" id="content">
                        ...
                        <?php $audio_file = public_path("/upload/blog/audio/".$blog_detail->audio_file); ?> @if($blog_detail->audio_file != '' && is_file($audio_file))
                            ...
                            <div class="post-2961 post type-post status-publish format-standard has-post-thumbnail hentry category-sports tag-inspire tag-relaxing tag-shooting" id="post-2961">
                                <div class="single_section_content box blog_large_post_style">
                                    ...
                                    <div class="single_tag_share">
                                        ...
                                        @if($blog_detail->url!='')
                                        <div class="pull-right source-div">
                                            Source:
                                    ...
                                    <div class="related-posts" id="load-data">
                                        ...
                                        <input type="hidden" id="active_category" value="11"/>
