                    ...
                    <div class="row">
                        <div class="col-md-12 main_title_col">
                            <div class="jl_cat_mid_title">
                                <h3 class="categories-title title">{{ __('frontend.my_feedback') }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-8 grid-sidebar">
                        ...
                        <div style="text-align:left;">
                            <form action="{{ route('my_feedback') }}" method="post">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="feed_back" id="exampleFormControlTextarea1" rows="3" required></textarea>
                                </div>   <br>                            
                                
                                <button type="submit" style="background-color: black; color: white; font-size: 13px; width: 110px; border-radius: 10px;">Submit</button>
