<div id="content_nav" class="jl_mobile_nav_wrapper">
    <div id="nav" class="jl_mobile_nav_inner">
        ...
        <ul id="mobile_menu_slide" class="menu_moble_slide">
            ...
            <li class="menu-item">
                <a href="{{url('category-blog')}}?category={{$header_data->name}}">{{$header_data->name}}<span class="border-menu"></span></a>
            </li>
            @endforeach
            ...
            @else
                <li class="menu-item">
                    <a href="{{url('user-login')}}">{{ __('frontend.login') }}<span class="border-menu"></span></a>
                </li>
            @endif
        </ul>
