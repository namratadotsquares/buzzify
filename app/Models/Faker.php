...
class Faker
{
    ...
    {
        $users = collect([
            [ 'name' => 'Johnny Depp', 'gender' => 'male','email'=>'johnnydepp1@example.com' ],
            [ 'name' => 'Al Pacino', 'gender' => 'male','email'=>'johnnydepp2@example.com' ],
            [ 'name' => 'Robert De Niro', 'gender' => 'male','email'=>'johnnydepp3@example.com' ],
            [ 'name' => 'Kevin Spacey', 'gender' => 'male','email'=>'johnnydepp4@example.com' ]
        ]);
        ...
        return $users->random(3)->map(function ($user) {
            return [
                'name' => $user['name'],
                'gender' => $user['gender'],
                'email' => strtolower(str_replace(' ', '', $user['name']) . '@example.com')
            ];
        });
    }
    ...
    public static function fakeDates()
    {
        ...
        for ($i = 0; $i < 5; $i++) {
            ...
            $dates[] = date("j F Y", mt_rand(1586584776, 1672333200) / 1000);
        }
